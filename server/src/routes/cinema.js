...
// Create a cinema
router.post('/cinemas', auth.is_auth, auth.is_admin_or_superadmin, async (req, res) => {
...
// Create a cinema (save photo)
router.post('/cinemas/photo/:id', auth.is_auth, auth.is_admin_or_superadmin, upload('cinemas').single('file'), async (req, res, next) => {
...
// Update cinema by id
router.patch('/cinemas/:id', auth.is_auth, auth.is_admin_or_superadmin, async (req, res) => {
  const _id = req.params.id;
...
// Delete cinema by id
router.delete('/cinemas/:id', auth.is_auth, auth.is_admin_or_superadmin, async (req, res) => {
  const _id = req.params.id;
  try {
